...
CREATE TEMP TABLE sub2macro(sub text PRIMARY KEY, macro text) ON COMMIT DROP;
...
CREATE TEMP TABLE source_region(src text PRIMARY KEY, macro text) ON COMMIT DROP;
